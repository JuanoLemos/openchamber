...
type DiligenciaHealthNotification = NotificationBase & {
  type: "diligencia-health"
  health?: { projectName: string; issues: number }
}

export type Notification = TurnCompleteNotification | ErrorNotification | DiligenciaHealthNotification
