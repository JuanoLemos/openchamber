...
const DILIGENCIA_FILES = new Set([
  'DILIGENCIA.md',
  'ROADMAP.md',
  'INDEX.md',
  'CHECKLIST.md',
    ...
    const rowContent = (
      <>
        ...
        >
          ...
          {DILIGENCIA_FILES.has(item.name) ? (
            <span className="ml-1 text-[9px] px-1 rounded font-medium bg-primary/10 text-primary dark:bg-primary/20 flex-shrink-0">
              D
            </span>
          ) : null}
        </button>
