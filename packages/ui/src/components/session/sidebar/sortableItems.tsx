            ...
            <div className="relative flex items-center gap-1 px-0.5 py-0.5" {...attributes}>
              <Tooltip>
                <TooltipTrigger asChild>
                    ...
                    {diligenciaVersion ? (
                      <span className="ml-1 text-[9px] px-1 py-px rounded font-medium bg-green-100/70 text-green-700 dark:bg-green-900/50 dark:text-green-400 flex-shrink-0">
                        {diligenciaVersion}
                      </span>
                    ) : null}
                  </button>
